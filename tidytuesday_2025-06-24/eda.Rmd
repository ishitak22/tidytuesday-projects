...
```{r bubbe_chart, echo=FALSE}
ggplot(bubble_df, aes(x = vaccine_coverage, y = mean_incidence)) +
  geom_point(aes(size = bubble_size, color = region), alpha = 0.7) +

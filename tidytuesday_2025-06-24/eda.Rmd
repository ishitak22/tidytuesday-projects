...
```
::: {style="background-color:#e7f3fe; padding:15px; border-left:5px solid #2196F3; color:black;"}
...
```{r scatter, echo=FALSE, warning=FALSE, fig.cap="Figure 3: Top-left = high incidence, low reporting | Top-right = high incidence & reporting", fig.width=18, fig.height=8}
cases_year %>%
  group_by(country, region) %>%
  summarise(
  ...
  geom_text(check_overlap = TRUE, size = 3.7, vjust = -0.5) +

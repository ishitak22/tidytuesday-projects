...
#### Interactive Heatmap:
 ...
 - Then user can click particular bar or organisation to see more details department wise
...
output$org_barplot <- renderPlotly({
  ...
  hoverinfo = "text", textposition = "none") %>%
    layout(title = paste("Top Organisations in", clicked_state()),
  xaxis = list(title = "Terminations"),
  yaxis = list(title = ""))
})
```

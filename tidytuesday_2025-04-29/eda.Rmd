...
ggraph(keyword_graph, layout = "fr") +                           
  ...
  labs(
    ...
    subtitle = "Edges connect keywords frequently co-mentioned across sessions",  
    caption = "Edge thickness = frequency of co-occurrence\nData: useR! 2025 Conference Program" 
  )
})
```
